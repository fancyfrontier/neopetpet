...
<meta charset="UTF-8">
    ...
    <!--light-slider-css-->
    <link rel='stylesheet' href="<c:url value='/Member/css/lightslider.css' />" type="text/css" />
    <!--jQuery-------->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"
			integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4="
			crossorigin="anonymous"></script>
    <!--light-slider-js-->
	<script type="text/javascript" src="<c:url value='/Member/js/lightslider.js' />"></script>
    <!--fav-icon------------------->
...
<!--navigation-------------------------------->
    ...
    <ul id="autoWidth" class="cs-hidden">
        ...
        <a href="#">
            <img src="<c:url value='/Member/images/feature_1.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="feature-box">
        <a href="#">
            <img src="<c:url value='/Member/images/feature_2.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="feature-box">
        <a href="#">
            <img src="<c:url value='/Member/images/feature_3.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="feature-box">
        <a href="#">
            <img src="<c:url value='/Member/images/feature_4.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="feature-box">
        <a href="#">
            <img src="<c:url value='/Member/images/feature_5.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="feature-box">
        <a href="#">
            <img src="<c:url value='/Member/images/feature_6.jpg' />" />
        </a>
        </div>
        <!--text---------------------------->
        <span>T-shirt</span>
        ...
        <div class="product-container">
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-1.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-2.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-3.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-4.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-5.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-6.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-7.jpg' />" />
                </div>
            ...
            <div class="product-box">
                ...
                <a href="#" class="add-cart">
                    ...
                    <img src="<c:url value='/Member/images/p-8.jpg' />" />
                </div>
    ...
    <section class="sale">
        ...
        <div class="sale-box sale-1">
            <img src="<c:url value='/Member/images/sale-1.jpg' />" />
           ...
           <!--sale-box-2-------------------->
        <div class="sale-box sale-1">
          <img src="<c:url value='/Member/images/sale-2.jpg' />" />
         ...
         <!--sale-box-3-------------------->
         <div class="sale-box sale-1">
          <img src="<c:url value='/Member/images/sale-3.jpg' />" />
