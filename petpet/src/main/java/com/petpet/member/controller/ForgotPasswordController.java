...
import com.petpet.member.service.MemberNotFoundException;
...
public class ForgotPasswordController {
	...
	public String ForgotPassWordSend(@RequestParam(name = "email") String email,
		...
		try {
			...
			return "Member/Tip/MemberCheckForgotMailTip";
	...
	public String processResetPassword(HttpServletRequest request, Model model) {
		...
		return "Member/Tip/MemberSuccessResetPwdTip";
	}
